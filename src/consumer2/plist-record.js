      ...
      */
      ...
      function _createDOM(obj){
        return [{
          ...
          onTap: function(){
            if(obj.type == 1){
              return Page.open("./detail.html", {projectid: obj.id});
            }else{
              return Page.open("../market/record-customer.html", {projectid: obj.id, pagetype: 4});
            }
          },
          components: [{
            tag: "img",
            ...
            components: [{
              ...
              html: "已预约{num}人".replace("{num}", obj.reportcnt | 0)
            },{
